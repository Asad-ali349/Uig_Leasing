...
@include('customer.includes.head')
   ...
   <style>
       #licenselink {
        ...
        #link-button{display:block;padding:10px 30px;color:white;background-color: tomato;margin:20px auto;}
        #link-button:hover{cursor: pointer;border:2px solid #555;color:#555;background-color: white;}
    </style>
    <body>   
      <!-- BEGIN LOADER -->
      <div id="load_screen">
            ...
            <div class="layout-px-spacing">
                @if($percentage < 99)
                    <div class="alert alert-danger " role="alert" id="alert">           
                        <strong>Profile not completed </strong>Please Complete your profile
                    </div> 
                @endif
                <div class="row ">
                    <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12 layout-top-spacing">
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                ...
                                <h4 class="" style="margin:5px;border-bottom: 2px solid #057485; ">My Profile</h4>
                                ...
                                <div class="text-center user-info">
                                    @if($customer->image=='')
                                    <img src="{{asset('public/assets/img/sample.png')}}" style="width:100px;height:120px" alt="avatar">
                                    @else
                    ...
                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="row">
                                ...
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="ml-2 row">
                                        <div class="col-md-6">
                                            <h6>Relative 1</h6>
                                            <div>
                                                <span><strong style="color:black">Name</strong>: {{count($customer->relative) != 0 ? $customer->relative[0]->relative_name : ''}}</span>
                                            </div>
                                            <div>
                                                <span><strong style="color:black">Telephone</strong>: {{count($customer->relative) != 0 ? $customer->relative[0]->relative_contact : ''}}</span>
                                            </div>
                                            <div>
                                                <span><strong style="color:black">Address</strong>: {{count($customer->relative) != 0  ? $customer->relative[0]->relative_city.', '.$customer->relative[0]->relative_state.', '.$customer->relative[0]->relative_zip : ''}}</span>
                                            </div>
                                            <div>
                                                <span><strong style="color:black">Relation</strong>: {{count($customer->relative) != 0 ? $customer->relative[0]->relationship : ''}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h6>Relative 2</h6>
                                            <div>
                                                <span><strong style="color:black">Name</strong>: {{count($customer->relative) != 0 ? $customer->relative[1]->relative_name : ''}}</span>

                                            </div>
                                            <div>
                                                <span><strong style="color:black">Telephone</strong>: {{count($customer->relative) != 0 ? $customer->relative[1]->relative_contact : ''}}</span>

                                            </div>
                                            <div>

                                                <span><strong style="color:black">Address</strong>: {{count($customer->relative) != 0 ? $customer->relative[1]->relative_city.', '.$customer->relative[1]->relative_state.', '.$customer->relative[1]->relative_zip : ''}}</span>
                                            </div>
                                            <div>
                                                <span><strong style="color:black">Relation</strong>: {{count($customer->relative) != 0 ? $customer->relative[1]->relationship : ''}}</span>
                                            </div>
                            ...
                            @if($plaid_array['bank_verified'] == '0')
                            <div class="col-lg-12 col-12 layout-spacing">
                                <div class="statbox widget box box-shadow">
                                    <div class="widget-header">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                <h3>Bank Account Verification Facility</h3>
                                            </div>                                                                        
                                        </div>
                                    </div>
                                    <div class="ml-2 row">
                                        <div class="col-md-6">
                                            <form id="payment-form">
                                                <div class="form-group">
                                                    <div id="plaid-response"></div>
                                                </div>
                                                <button type="button" id="link-button">
                                                    Verify Bank Via Plaid
                                                </button>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <script type="text/javascript">
                                (async function() {
                                  ...
                                  const configs = {
                                    clientName: '{{$plaid_array["plaid_ustring"]}}',
                                    env: '{{$plaid_array["setup_variable"]}}',
                                    product: ['auth'],
                                    token: '{{$plaid_array["plaid_public_token"]}}',
                                    onSuccess: async function(public_token, metadata) {
                                      await fetch('/lease/customer/bank_account_verification?public_token='+public_token+'&account_id='+metadata.accounts[0].id, {
                                        method: 'GET'
                                        ...
                                        response.json().then(function(data) {
                                            ...
                                            if(data.status == "success")
                                            {
                                                ...
                                                $("#plaid-response").html("<span style='color:green;'>Verification is completed successfully.</span>");
                                            }
                                            else
                                            {
                                                $("#plaid-response").html("<span style='color:tomato;'>Verification is not completed successfully.</span>");
                                            }
                                        });
                    ...
                    <div class="col-lg-12 col-12 layout-spacing">
                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="ml-2 row">
                                ...
                                <div class="col-md-12">
                                    <span><strong style="color:black">Address</strong>: {{$customer->income != null ? $customer->income->employer_city.', '.$customer->income->employer_state.', '.$customer->income->employer_zip : ''}}</span>
                                </div>
                                <div class="col-md-6">
