								...
								<div class="col-lg-12 col-12 ">
									<div class="statbox widget box box-shadow mb-4">
										...
										<div class="widget-content">
											<form action="{{url('customer/upload_ticket_docs')}}" enctype="multipart/form-data" class="dropzone" id="dropzonewidget">
											</form>
										</div>
									</div>
								</div>
                                        ...
                                        <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <span class="shadow-none badge badge-primary ">customer
                                                    </td>
                                                    <td >
														@php 
