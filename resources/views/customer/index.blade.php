                            ...
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{Url('customer/forget_password')}}" class="forgot-pass-link">Forgot Password?</a>
                                    </div>
                                ...
                                <p class="signup-link">Not registered ? <a href="{{Url('customer/register')}}">Create an account</a></p>
