                        ...
                        <div class="col-lg-12 col-12 layout-spacing">
                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$count}}</td>
                                        <td>{{$dealer->dealer->owner_name}}</td>
                                        <td>{{$dealer->dealer->email}}</td>
                                        <td>{{$dealer->dealer->shop_contact}}</td>
                                        <td>
                                            <a href="{{Url('customer/dealer_info/'.$dealer->dealer->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    @php
                                    $count++;
