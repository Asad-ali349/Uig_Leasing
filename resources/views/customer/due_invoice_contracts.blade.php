                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="dt-no-sorting">Due Invoice</th>
                                ...
                                <?php 
                                        ...
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>{{$contract->dealer}}</td>
                                            <td>{{$contract->type}}</td>
                                            <td>${{$contract->amount}}</td>
                                            <td>{{$contract->total_years}} years</td>
                                            <td>{{$contract->count}} </td>
                                            <td>
                                                @if($contract->count>3)
                                                <span class="shadow-none badge badge-danger ">Danger
                                                @else
                                                <span class="shadow-none badge badge-success ">Approved
                                                @endif
                                            </td>
                                            <td>
                                                <a href="{{Url('customer/due_invoice/'.$contract->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
