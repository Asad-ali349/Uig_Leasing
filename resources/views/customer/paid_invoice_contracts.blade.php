                        ...
                        <div class="col-lg-12 col-12 layout-spacing">
                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <?php 
                                        ...
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>{{$contract->contract->dealer->owner_name}}</td>
                                            ...
                                            <td>
                                                <a href="{{Url('customer/paid_invoice/'.$contract->contract->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
