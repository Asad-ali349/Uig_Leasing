				...
				<div class="form-form-wrap">
					<div class="form-container">
						<div class="form-content">
							...
							<p class="signup-link register">Already have an account? <a href="{{Url('customer')}}">Log in</a></p>
							@if(session('error_msg'))
								{{session('error_msg')}}
							@endif
							<form class="text-left" action="{{Url('createCustomer')}}" method="POST">
								<div class="form">
									@csrf
									<div id="username-field" class="field-wrapper input">
										...
										<input id="username" name="username" type="text" class="form-control" placeholder="Full Name" required>
									</div>
