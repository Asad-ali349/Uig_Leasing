            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <a href="{{url('customer/verify/'.$link)}}">click to verify</a>
                        <p class="signup-link" id="resendtimer">Resend Link in <span id="text"></span></p>
                        <p class="signup-link" style="display:none" id="resendlink"><a href="{{url('customer/resendVerification/'.$resend)}}" >Resend Link</a></p>
                    </div>                    
                </div>
            </div>
        </div>
