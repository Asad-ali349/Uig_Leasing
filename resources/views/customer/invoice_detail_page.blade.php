                                                        ...
                                                        <div class="inv--detail-section inv--customer-detail-section">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                                    <p class="inv-customer-name">{{$contract_dealer->dealer->owner_name}}</p>
                                                                    <p class="inv-street-addr">{{$contract_dealer->dealer->shop_address.",".$contract_dealer->dealer->shop_city.",".$contract_dealer->dealer->shop_country}}</p>
                                                                    <p class="inv-email-address">{{$contract_dealer->dealer->email}}</p>
                                                                    <p class="inv-email-address">+1 {{$contract_dealer->dealer->shop_contact}}</p>
                                                                </div>
                                                                
                                                                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8 col-12 order-sm-0 order-1">
                                                                    <div class="inv--payment-info">
                                                                        <p class="inv-customer-name">{{Auth::guard('customer')->user()->name}}</p>
                                                                        <p class="inv-street-addr">{{Auth::guard('customer')->user()->street.",".Auth::guard('customer')->user()->city.",".Auth::guard('customer')->user()->country}}</p>
                                                                        <p class="inv-email-address">{{Auth::guard('customer')->user()->email}}</p>
                                                                        <p class="inv-email-address">+1 {{Auth::guard('customer')->user()->contact}}</p>
