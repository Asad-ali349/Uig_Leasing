        ...
        <div class="sidebar-wrapper sidebar-theme" >
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu ">
                        <a href="{{Url('customer/dashboard')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('customer/customer_details')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('customer/add_contract')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Lease" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('customer/non_approved_contract')}}"> Non Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('customer/approved_contract')}}"> Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('customer/rejected_contract')}}"> Rejected</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Vendors" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('customer/create_ticket')}}"> Add Tickect</a>
                            </li>
                            <li>
                                <a href="{{Url('customer/non_approved_ticket')}}"> View Tickects</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="{{Url('customer/view_dealers')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usernotes" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('customer/add_notes')}}"> Add Notes</a>
                            </li>
                            <li>
                                <a href="{{Url('customer/view_notes')}}"> View Notes</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="invoice" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('customer/due_invoice_contracts')}}"> Due</a>
                            </li>
                            <li>
                                <a href="{{Url('customer/paid_invoice_contracts')}}"> Paid</a>
                            </li>
                        </ul>
                    </li>
    ...
    <!-- <script>
        $(document).ready(function() {
            $.get("{{url('customer/calculate_profile')}}").then((result)=> {
                    console.log(result);
                    document.getElementById("profilestatus").innerHTML= Math.floor(result)+"%";
            })
        });
    </script> -->