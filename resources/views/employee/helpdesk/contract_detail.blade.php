					...
					<div class="row mb-5">
								...
								<div class="widget-header">
									<div class="row">
										...
										<div class="col-xl-2 col-md-2 col-sm-2 col-2">
											<span class="shadow-none badge badge-primary "><a href="{{Url('employee/helpdesk/invoice_detail_page/'.$get_contract->id)}}" style="color:white">View Inoices</a>
										</div>
										<div class="col-xl-2 col-md-2 col-sm-2 col-2">
						...
						<div class="col-lg-12 col-12 ">
							<div class="statbox widget box box-shadow mb-4">
								...
								<form action="{{url('employee/helpdesk/upload_contract_docs')}}" enctype="multipart/form-data" class="dropzone" id="dropzonewidget">
									</form>
								</div>
							</div>
						</div>
