<!DOCTYPE html>
<html lang="en">
@include('employee.helpdesk.includes.head')
...
<body>
    ...
    @include('employee.helpdesk.includes.topbar')
    ...
    @include('employee.helpdesk.includes.navbar')
        ...
        <div id="content" class="main-content">
                                    ...
                                    @foreach($notes as $note)
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting">
                                                ...
                                                @if($note->status==0)
                                                    <a href="{{url('employee/helpdesk/edit_notes/'.$note->id)}}"><i class="far fa-edit"  style="color: blue; font-size: 18px;" aria-hidden="true"></i></a>
                                                    <a href="{{url('employee/helpdesk/mark_as_done_notes/'.$note->id)}}"><i class="far fa-check-circle"  style="color: green; font-size: 18px;" aria-hidden="true"></i></a>
                                                @endif
                                                
                                                <a href="{{url('employee/helpdesk/delete_notes/'.$note->id)}}"><i class="far fa-times-circle" onclick="return confirm('Are you sure?')" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                            </td>
            ...
            @include('employee.helpdesk.includes.footer')
