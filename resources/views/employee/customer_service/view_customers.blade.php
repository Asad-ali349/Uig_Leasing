                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{Url('employee/customer_service/customer_details/'.$customer->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            <a href="mailto:{{$customer->email}}"><i class="far fa-envelope" style="color: blue; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
