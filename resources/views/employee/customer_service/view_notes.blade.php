<!DOCTYPE html>
<html lang="en">
@include('employee.customer_service.includes.head')
...
<body>
    ...
    @include('employee.customer_service.includes.topbar')
    ...
    @include('employee.customer_service.includes.navbar')
        ...
        <div id="content" class="main-content">
                                    ...
                                    @foreach($notes as $note)
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting">
                                                ...
                                                @if($note->status==0)
                                                    <a href="{{url('employee/customer_service/edit_notes/'.$note->id)}}"><i class="far fa-edit"  style="color: blue; font-size: 18px;" aria-hidden="true"></i></a>
                                                    <a href="{{url('employee/customer_service/mark_as_done_notes/'.$note->id)}}"><i class="far fa-check-circle"  style="color: green; font-size: 18px;" aria-hidden="true"></i></a>
                                                @endif
                                                
                                                <a href="{{url('employee/customer_service/delete_notes/'.$note->id)}}"><i class="far fa-times-circle" onclick="return confirm('Are you sure?')" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                            </td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color: #181818 ;">
                                                        <h5 class="modal-title" style="color:white;font-weight: 50px; font-size: 30px;">{{$note->title}}</h5>
                                ...
                                <table id="html6-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting"> 
                                                <a data-toggle="modal" data-target="#pending{{$note->id}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                                @if($note->status==0)
                                                    <a href="{{url('employee/customer_service/edit_notes/'.$note->id)}}"><i class="far fa-edit"  style="color: blue; font-size: 18px;" aria-hidden="true"></i></a>
                                                    <a href="{{url('employee/customer_service/mark_as_done_notes/'.$note->id)}}"><i class="far fa-check-circle"  style="color: green; font-size: 18px;" aria-hidden="true"></i></a>
                                                @endif
                                        ...
                                        <div class="modal md" id="pending{{$note->id}}" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color: #181818 ;">
                                                        <h5 class="modal-title" style="color:white;font-weight: 50px; font-size: 30px;">{{$note->title}}</h5>
                                ...
                                <table id="html9-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting">
                                                <a data-toggle="modal" data-target="#completed{{$note->id}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                                <a href="{{url('employee/customer_service/delete_notes/'.$note->id)}}"><i class="far fa-times-circle" onclick="return confirm('Are you sure?')" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                            </td>
                                            
                                        </tr>
                                        <div class="modal md" id="completed{{$note->id}}" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color: #181818 ;">
                                                        <h5 class="modal-title" style="color:white;font-weight: 50px; font-size: 30px;">{{$note->title}}</h5>
            ...
            @include('employee.customer_service.includes.footer')
