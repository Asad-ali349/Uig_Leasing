	...
	<body>
							...
							<div class="user-profile layout-spacing">
								<div class="widget-content widget-content-area">
									...
									<div class="text-center user-info">
										...
										<p class="">{{$get_contract->dealer->shop_name}}</p>
									</div>
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 layout-top-spacing">
							<div class="user-profile layout-spacing">
								<div class="widget-content widget-content-area">
									...
									<div class="text-center user-info">
										<img src="{{asset('storage/app/'.$get_contract->customer->image)}}" style="width:100px;height:120px" alt="avatar">
										<p class="">{{$get_contract->customer->name}}</p>
									</div>
									<div class="user-info-list">
										<div class="">
											<ul class="contacts-block list-unstyled">
												<li class="contacts-block__item">
													...
													{{$get_contract->customer->street.', '.$get_contract->customer->city.', '.$get_contract->customer->state.', '.$get_contract->customer->zip.', '.$get_contract->customer->country}}
												</li>
												<li class="contacts-block__item">
													<a href="mailto:example@mail.com">
														<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
												...
												<li class="contacts-block__item">
													...
													+1 {{$get_contract->customer->contact}}
												</li>
											</ul>
										</div>
									</div>
					...
					<div class="row mb-5">
								...
								<div class="widget-header">
									<div class="row">
										...
										<div class="col-xl-2 col-md-2 col-sm-2 col-2">
											<span class="shadow-none badge badge-primary "><a href="{{Url('employee/customer_service/invoice_detail_page/'.$get_contract->id)}}" style="color:white">View Inoices</a>
										</div>
										<div class="col-xl-2 col-md-2 col-sm-2 col-2">
											<span class="shadow-none badge badge-primary "><a href="" style="color:white">View Contract</a>
										</div>  
						...
						<div class="col-lg-12 col-12 ">
							<div class="statbox widget box box-shadow mb-4">
								...
								<form action="{{url('employee/customer_service/upload_contract_docs')}}" enctype="multipart/form-data" class="dropzone" id="dropzonewidget">
									</form>
								</div>
							</div>
						</div>
									...
									<tbody>
										...
										@if(count($get_contract->customer_docs) > 0)
											...
											<tr>
												...
												<td>
												<span class="shadow-none badge badge-primary ">{{$get_contract->	customer->name." [Customer]";}}
												</td>
												<td >
													@php
													$d=strtotime($docs->created_at);
		...
		<script>
			...
			myDropzone.on("sending", function(file, xhr, formData) {
					...
					formData.append("employee_id","{{Auth::guard('employee')->user()->id}}");
