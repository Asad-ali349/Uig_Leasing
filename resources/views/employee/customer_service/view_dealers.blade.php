                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$dealer->email}}</td>
                                        <td>{{$dealer->shop_contact}}</td>
                                        <td>
                                            <a href="{{Url('employee/customer_service/dealer_info/'.$dealer->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            <a href="mailto:{{$dealer->email}}"><i class="far fa-envelope" style="color: blue; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
