        ...
        <div class="sidebar-wrapper sidebar-theme" >
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu ">
                        <a href="{{Url('employee/account_receive/dashboard')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/account_receive/employee_info')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/account_receive/non_approved_ticket')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/account_receive/view_customers')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Lease" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/account_receive/non_approved_contract')}}"> Non Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/account_receive/approved_contract')}}"> Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/account_receive/rejected_contract')}}"> Rejected</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usernotes" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/account_receive/add_notes')}}"> Add Notes</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/account_receive/view_notes')}}"> View Notes</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usertask" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/account_receive/add_task')}}"> Add Task</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/account_receive/view_todo_list')}}"> View Tasks</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="invoice" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/account_receive/due_invoice_contract')}}"> Due</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/account_receive/paid_invoice_contract')}}"> Paid</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="{{Url('employee/account_receive/customer_transaction')}}" class="dropdown-toggle" id="single">
                            <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
