                        ...
                        <div class="col-lg-12 col-12 layout-spacing">
                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>{{$contract->contract->customer->name}}</td>
                                            <td>{{$contract->contract->contract_type->name}}</td>
                                            <td>${{$contract->contract->amount}}</td>
                                            <td>{{$contract->contract->total_years}} years</td>
                                            <td><span class="shadow-none badge badge-success ">approved</td>
                                            <td>
                                                <a href="{{Url('employee/account_receive/paid_invoice/'.$contract->contract->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
