<!DOCTYPE html>
<html lang="en">
@include('employee.account_recieve.includes.head')
<link href="{{asset('public/assets/css/users/user-profile.css')}}" rel="stylesheet" type="text/css" />
   ...
   <link rel="stylesheet" type="text/css" href="{{asset('public/plugins/editors/quill/quill.snow.css')}}">
    <body>   
      ...
      <!--  END LOADER -->
      @include('employee.account_recieve.includes.topbar')
      <!--  BEGIN MAIN CONTAINER  -->
      <div class="main-container" id="container">
      @include('employee.account_recieve.includes.navbar')
         ...
         <div id="content" class="main-content">
                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="text-center user-info">
                                    <img src="{{asset('public/assets/img/90x90.jpg')}}" alt="avatar">
                                    <p class="">Shop Name</p>
                                </div>
                                <div class="user-info-list">
                                    ...
                                    <div class="">
                                        <ul class="contacts-block list-unstyled">
                                            ...
                                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> Dealer
                                            </li>
                                            <li class="contacts-block__item">
                                            ...
                                            <li class="contacts-block__item">
                                            <i class="far fa-id-card" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;&nbsp;525696
                                            </li>
                                            <li class="contacts-block__item">
                                    ...
                                    <table id="html7-extension" class="table table-hover non-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="dt-no-sorting">Telephone</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>+92 333 5254963</td>

                                                <td>
                                                    <a href="{{Url('employee/account_recieve/customer_details')}}" >
                                                        <i class="far fa-user" style="color: green;font-size: 18px" aria-hidden="true"></i></a>
                                                    <!-- <a href="#"><i class="far fa-edit" style="color: blue; font-size: 18px;margin-right: 5px;margin-left:10px" aria-hidden="true"></i></a> -->
                                                    <a data-toggle="modal" data-target="#modal"><i class="far fa-envelope" style="color: blue; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                                </td>
            ...
            @include('employee.account_recieve.includes.footer')
         </div>
         <!--  END CONTENT PART  -->
      </div>
      <!-- END MAIN CONTAINER -->
