                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Ali</td>
                                        <td>ali@gmail.com</td>
                                        <td>+92 333 9638521</td>
                                        <td>
                                            <a href="{{Url('employee/account_recieve/dealer_info')}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
