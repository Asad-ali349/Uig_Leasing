                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="dt-no-sorting">Shedule Amount</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$count}}</td>
                                        <td>{{$transaction->contract->customer->name}}</td>
                                        <td>{{$transaction->contract->contract_type->name}}</td>
                                        <td>${{$transaction->contract->amount}}</td>
                                        <td>${{$transaction->invoice->total_amount_to_pay+$transaction->invoice->late_fee}}</td>
                                        ...
                                        <td>@php
                                                ...
                                                {{$d}}</td>
                                        <td>
                                            <a href="{{Url('employee/account_receive/paid_invoice_detail/'.$transaction->invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
