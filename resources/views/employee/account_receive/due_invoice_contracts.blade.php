                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="dt-no-sorting">Due Invoices</th>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{Url('employee/account_receive/due_invoice/'.$contract->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
