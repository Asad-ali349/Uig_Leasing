                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="dt-no-sorting">Payable amount</th>
                                        <th class="dt-no-sorting">Paid Amount</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$count}}</td>
                                        <td>{{$transaction->contract->dealer->owner_name}}</td>
                                        <td>{{$transaction->contract->contract_type->name}}</td>
                                        <td>${{$transaction->contract->amount}}</td>
                                        <td>${{$transaction->invoice->amount}}</td>
                                        ...
                                        <td>
                                            <a href="{{Url('employee/account_pay/dealer_invoice_detail/'.$transaction->invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
