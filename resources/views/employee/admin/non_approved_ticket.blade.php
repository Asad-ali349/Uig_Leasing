                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting">
                                                <a href="{{url('employee/admin/view_detail_ticket_customer/'.$ticket->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                                ...
                                                <div class="" style="display:inline">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" >
                                                        <a class="dropdown-item" href="{{url('/employee/admin/change_customer_ticket_status/'.$ticket->id.'/2')}}">Mark as inprogress</a>
                                                        <a class="dropdown-item" href="{{url('/employee/admin/change_customer_ticket_status/'.$ticket->id.'/3')}}">Mark as completed </a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting">
                                                <a href="{{url('employee/admin/view_detail_ticket_dealer/'.$ticket->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 5px" aria-hidden="true"></i></a>
                                                ...
                                                <div class="" style="display:inline">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="{{url('/employee/admin/change_dealer_ticket_status/'.$ticket->id.'/2')}}">Mark as inprogress</a>
                                                        <a class="dropdown-item" href="{{url('/employee/admin/change_dealer_ticket_status/'.$ticket->id.'/3')}}">Mark as completed</a>
                                                    </div>
                                                </div>
                                                @endif
                                            </td>
