                            ...
                            <div class="modal md" id="modal" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{url('employee/admin/filter_invoices')}}" method="post">
                                            @csrf
                                            <div class="row">
                                    ...
                                    ?>
                                     @foreach($contracts as $contract)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{Url('employee/admin/contract_detail/'.$contract->id)}}" data-toggle="tooltip" data-placement="top" title="Contract Detail"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>

                                                <a href="{{url('employee/admin/contract_invoice_customer/'.$contract->id)}}" data-toggle="tooltip" data-placement="top" title="Customer Invoices"><svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 10px" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="blue" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></a>

                                                <a href="{{url('employee/admin/contract_invoice_dealer/'.$contract->id)}}" data-toggle="tooltip" data-placement="top" title="Dealer Invoices"><svg viewBox="0 0 24 24" width="22" height="22" stroke="orange" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg></a>
                                            </td>
