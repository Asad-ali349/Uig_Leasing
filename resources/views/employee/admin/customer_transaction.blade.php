                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@php
                                                ...
                                                {{$d}}</td>
                                        <td>
                                            <a href="{{Url('employee/admin/paid_invoice_detail/'.$transaction->invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
