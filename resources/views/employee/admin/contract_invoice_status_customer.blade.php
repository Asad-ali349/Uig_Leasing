                                    ...
                                    <tbody>
                                        ...
                                        @foreach($in as $invoice)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{Url('employee/admin/due_invoice_detail/'.$invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                                </td>
                                ...
                                <table id="html6-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{Url('employee/admin/paid_invoice_detail/'.$invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
