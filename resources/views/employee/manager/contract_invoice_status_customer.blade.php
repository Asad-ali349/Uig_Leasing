                ...
                <div id="tabsIcons" class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <ul class="nav nav-tabs  mb-3 mt-3" id="iconTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="icon-home-tab" data-toggle="tab" href="#icon-home" role="tab" aria-controls="icon-home" aria-selected="true"> Pending</a>
                            </li>
                           <li class="nav-item">
                                <a class="nav-link" id="icon-profile-tab" data-toggle="tab" href="#icon-profile" role="tab" aria-controls="icon-profile" aria-selected="true"> Paid</a>
                            </li>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($in as $invoice)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{Url('employee/manager/due_invoice_detail/'.$invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                                </td>
                                ...
                                <table id="html6-extension" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="dt-no-sorting">Schedule Payments</th>
                                            <th class="dt-no-sorting">Due date</th>
                                            <th class="dt-no-sorting">Paid date</th>
                                            <th class="dt-no-sorting">Status</th>
                                            <th class="dt-no-sorting">Action</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> @php
                                                ...
                                                {{$d}}</td>
                                            <td>@php
                                                 $date=strtotime($invoice->paid_date);
                                                    $d=date("F d, Y",$date);
                                                @endphp
                                                {{$d}}</td>
                                            <td><span class="shadow-none badge badge-success">Paid</td>
                                            <td>
                                                <a href="{{Url('employee/manager/paid_invoice_detail/'.$invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
