                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="dt-no-sorting">Role</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>+92 {{$employee->contact}}</td>
                                        <td><span class="shadow-none badge badge-primary">{{$employee->role->name}}</td>
                                        <td>
                                            <a href="{{Url('employee/manager/view_employee_detail/'.$employee->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
