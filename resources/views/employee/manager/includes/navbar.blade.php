        ...
        <div class="sidebar-wrapper sidebar-theme" >
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu ">
                        <a href="{{Url('employee/manager/dashboard')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/manager/employee_info')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/manager/non_approved_ticket')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="employee" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{Url('employee/manager/add_employee')}}"> Add Employee</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/view_employee')}}"> View Employee</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="#dealer" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle" id="two">
                            <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span>Dealer</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled" id="dealer" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{Url('employee/manager/add_dealer')}}"> Add dealer</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/view_dealers')}}"> View Dealers</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="{{Url('employee/manager/view_customers')}}" class="dropdown-toggle" id="single">
                            <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                            <span>Customer</span>
                            </div>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Lease" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/manager/non_approved_contract')}}"> Non Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/approved_contract')}}"> Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/rejected_contract')}}"> Rejected</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usernotes" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/manager/add_notes')}}"> Add Notes</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/view_notes')}}"> View Notes</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usertask" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/manager/add_task')}}"> Add Task</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/view_todo_list')}}"> View Tasks</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="invoice" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/manager/due_invoice_contract')}}"> Due</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/paid_invoice_contract')}}"> Paid</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="dealer_invoice" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/manager/dealer_due_invoice')}}"> Due</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/dealer_paid_invoice')}}"> Paid</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="transaction" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/manager/dealer_transaction')}}"> Dealer</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/manager/customer_transaction')}}"> Customer</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="{{Url('employee/manager/view_reports')}}" class="dropdown-toggle" id="single">
                            <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                            <span>Reports</span>
                            </div>
