                                        ...
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting">
                                                ...
                                                @if($task->status==0)
                                                    ...
                                                    <a href="{{url('employee/manager/mark_as_done_tasks/'.$task->id)}}"><i class="far fa-check-circle"  style="color: green; font-size: 18px;" aria-hidden="true"></i></a>
                                                @endif
                                                
                                                <a href="{{url('employee/manager/delete_tasks/'.$task->id)}}"><i class="far fa-times-circle" onclick="return confirm('Are you sure?')" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                            </td>
