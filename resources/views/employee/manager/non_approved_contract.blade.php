                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{Url('employee/manager/contract_detail/'.$contract['id'])}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
