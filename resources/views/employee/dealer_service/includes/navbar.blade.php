        ...
        <div class="sidebar-wrapper sidebar-theme" >
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu ">
                        <a href="{{Url('employee/dealer_service/dashboard')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/dealer_service/employee_info')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/dealer_service/non_approved_ticket')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/dealer_service/view_dealers')}}" class="dropdown-toggle" id="single">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{Url('employee/dealer_service/view_customers')}}" class="dropdown-toggle" id="single">
                            <div class="">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                            <span>Customer</span>
                            </div>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Lease" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/dealer_service/non_approved_contract')}}"> Non Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/dealer_service/approved_contract')}}"> Approved</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/dealer_service/rejected_contract')}}"> Rejected</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usernotes" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/dealer_service/add_notes')}}"> Add Notes</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/dealer_service/view_notes')}}"> View Notes</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="usertask" data-parent="#accordionExample">
                            <li>
                                <a href="{{Url('employee/dealer_service/add_task')}}"> Add Task</a>
                            </li>
                            <li>
                                <a href="{{Url('employee/dealer_service/view_todo_list')}}"> View Tasks</a>
                            </li>
                        </ul>
                    </li>
