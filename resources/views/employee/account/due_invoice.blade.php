                                ...
                                <tbody>
                                    ...
                                    @foreach($in as $invoice)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{Url('employee/account/due_invoice_detail/'.$invoice->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
