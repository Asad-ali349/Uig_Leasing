...
<body>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mt-4">
                                                    <div class="n-chk">
                                                        ...
                                                        <input type="radio" class="new-control-input" name="custom-radio-1" onchange="handleChange1('','');" checked>
                                                ...
                                                <div class="col-md-4 mt-4">
                                                    ...
                                                    <div class="n-chk">
                                                        <label class="new-control new-radio">
                                                        <input type="radio" class="new-control-input" name="custom-radio-1" onchange="handleChange1('dealer','customer');" >
                                                ...
                                                <div class="col-md-4 mt-4">
                                                    <div class="n-chk">
                                                        <label class="new-control new-radio">
                                                        <input type="radio" class="new-control-input" name="custom-radio-1" onchange="handleChange1('customer','dealer');">
                                    ...
                                    <div class="widget widget-one_hybrid widget-followers">
                                        <div class="widget-heading">
                                            <div class="w-title">
                                                ...
                                                <div class="">
                                                    <p class="w-value">$7,000</p>
                                                    <h5 class=""> From Customers</h5>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Invoice Number</th>
                                        <th class="dt-no-sorting">Contract Type</th>
                                        <th class="dt-no-sorting">Recived Amount</th>
                                        <th class="dt-no-sorting">Recived date</th>
                                        <th class="dt-no-sorting">Action</th>
    ...
    <script >
        ...
        $( "#dealer" ).change(function() {
            var val=document.getElementsByName("dealer");
