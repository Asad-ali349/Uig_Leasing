	...
	<body>
							...
							<div class="row">
										...
										<div class="widget-header">
											<div class="row">
                                                ...
                                                <div class="col-xl-2 col-md-2 col-sm-2 col-2">
                                                    <span class="shadow-none badge badge-primary "><a href="{{Url('dealer/invoice_detail_page/'.$get_contract->id)}}" style="color:white">View Inoices</a>
												</div>
                                                <div class="col-xl-2 col-md-2 col-sm-2 col-2">
								...
								<div class="col-lg-12 col-12 ">
									<div class="statbox widget box box-shadow mb-4">
										...
										<form action="{{url('dealer/upload_contract_docs')}}" enctype="multipart/form-data" class="dropzone" id="dropzonewidget">
											</form>
										</div>
									</div>
								</div>
									...
									<tbody>
										...
										@if(count($get_contract->dealer_docs) > 0)
											...
											<tr>
												...
												<td>
												<span class="shadow-none badge badge-primary ">{{Auth::guard('dealer')->user()->owner_name." [You]";}}
												</td>
												<td >
													@php
		...
		<script>
			...
			myDropzone.on("sending", function(file, xhr, formData) {
					...
					formData.append("dealer_id","{{Auth::guard('dealer')->user()->id}}");
