            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing mb-4">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 layout-spacing">
                        <a href="{{Url('dealer/non_approved_contract')}}"><div class="widget widget-one_hybrid widget-followers">
                            <div class="widget-heading">
                                <div class="w-title">
                                    <div class="w-icon">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 layout-spacing">
                        <a href="{{Url('dealer/approved_contract')}}"><div class="widget widget-one_hybrid widget-followers">
                            <div class="widget-heading">
                                <div class="w-title">
                                    <div class="w-icon">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 layout-spacing">
                        <a href="{{Url('dealer/rejected_contract')}}"><div class="widget widget-one_hybrid widget-followers">
                            <div class="widget-heading">
                                <div class="w-title">
                                    <div class="w-icon">
                    ...
                    <!-- <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 layout-spacing">
                        <a href="#"><div class="widget widget-one_hybrid widget-followers">
                            <div class="widget-heading">
                                <div class="w-title">
                                    <div class="w-icon">
                        ...
                        <div class="widget widget-one_hybrid widget-followers">
                            <div class="widget-heading">
                                <div class="w-title">
                                    ...
                                    <div class="">
                                        <p class="w-value">{{$inpr_tickets}}</p>
                        ...
                        <div class="widget widget-one_hybrid widget-followers">
                            <div class="widget-heading">
                                <div class="w-title">
                                    ...
                                    <div class="">
                                        <p class="w-value">{{$comp_tickets}}</p>
