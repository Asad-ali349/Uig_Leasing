                                    ...
                                    <div class="">
                                        <ul class="contacts-block list-unstyled">
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>{{$customer->street.', '.$customer->city.', '.$customer->state.', '.$customer->zip.', '.$customer->zip}}
                                            </li>
                                            <li class="contacts-block__item">
                                            ...
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>  <a href="callto:+1{{$customer->shop_contact}}">+1{{$customer->contact}}</a>
                                            </li>
                                        </ul>
                                    </div>                                    
                                </div>
                            ...
                            <div class="col-lg-12 col-12 layout-spacing">
                                ...
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="ml-2 row">
                                        ...
                                        <div class="col-md-6">
                                            <span><strong style="color:black">Bank Name</strong>: {{$customer->bank->bank_name}}</span>
                                        </div>
                                        <div class="col-md-6">
                                            <span><strong style="color:black">Bank Telephone</strong>: {{$customer->bank->bank_contact}}</span>
                                        </div>
                                        <div class="col-md-6">
                                            <span><strong style="color:black">Account Type</strong>: {{$customer->bank->account_type}}</span>
                                        </div>
                                        <div class="col-md-6">
                                            <span><strong style="color:black">Account Number</strong> : {{$customer->bank->account_number}}</span>
                                        </div>
                                        <div class="col-md-6">
                                            <span><strong style="color:black">Card type</strong>: {{$customer->bank->card_type}} </span>
                                        </div>
                                        <div class="col-md-6">
                                            <span><strong style="color:black">Card Nymber</strong>: {{$customer->bank->card_number}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{Url('dealer/contract_detail/'.$contract['id'])}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                            </td>
