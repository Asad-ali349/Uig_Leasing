                            ...
                            <div class=" widget-content widget-content-area br-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$customer->customer->contact}}</td>
                                        <td>
                                            <a href="{{Url('dealer/customer_details/'.$customer->customer->id)}}"><i class="far fa-list-alt" style="color: green; font-size: 18px;margin-right: 10px" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    @php
                                    $count++;
