                                    ...
                                    @foreach($notes as $note)
                                        <tr>
                                            ...
                                            <td class="dt-no-sorting">
                                                ...
                                                @if($note->status==0)
                                                    <a href="{{url('dealer/edit_notes/'.$note->id)}}"><i class="far fa-edit"  style="color: blue; font-size: 18px;" aria-hidden="true"></i></a>
                                                    <a href="{{url('dealer/mark_as_done_notes/'.$note->id)}}"><i class="far fa-check-circle"  style="color: green; font-size: 18px;" aria-hidden="true"></i></a>
                                                @endif
                                                
                                                <a href="{{url('dealer/delete_notes/'.$note->id)}}"><i class="far fa-times-circle" onclick="return confirm('Are you sure?')" style="color: red; font-size: 18px;" aria-hidden="true"></i></a>
                                            </td>
