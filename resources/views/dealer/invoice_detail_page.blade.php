                                                        ...
                                                        <div class="inv--detail-section inv--customer-detail-section">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                                    <p class="inv-customer-name">{{Auth::guard('dealer')->user()->owner_name}}</p>
                                                                    <p class="inv-street-addr">{{Auth::guard('dealer')->user()->shop_address.",".Auth::guard('dealer')->user()->shop_city.",".Auth::guard('dealer')->user()->shop_country}}</p>
                                                                    <p class="inv-email-address">{{Auth::guard('dealer')->user()->email}}</p>
                                                                    <p class="inv-email-address">+1 {{Auth::guard('dealer')->user()->shop_contact}}</p>
                                                                </div>
                                                                
                                                                <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8 col-12 order-sm-0 order-1">
                                                                    <div class="inv--payment-info">
                                                                        <p class="inv-customer-name">{{$contract_customer->customer->name}}</p>
                                                                        <p class="inv-street-addr">{{$contract_customer->customer->street.",".$contract_customer->customer->city.",".$contract_customer->customer->country}}</p>
                                                                        <p class="inv-email-address">{{$contract_customer->customer->email}}</p>
                                                                        <p class="inv-email-address">+1 {{$contract_customer->customer->contact}}</p>
