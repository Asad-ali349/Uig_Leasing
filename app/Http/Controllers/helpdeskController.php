...
class helpdeskController extends Controller
{
    ...
    // {
    //     return view('employee/helpdesk/view_notes');
    // }
    ...
    public function employee_info()
    {
        ...
        return view('employee/helpdesk/employee_info',compact('employee'));
    }
    public function edit_employee_info()
    {
        ...
        $employee=employees::where('id',$user_id)->first();
        // dd($employee);
        return view('employee/helpdesk/edit_employee_info',compact('employee'));
    }
    ...
    public function create_ticket()
    {
        ...
        return view('employee/helpdesk/create_ticket');
    }

    public function view_detail_ticket_dealer($id)
    {   
        $ticket=dealer_ticket::with(['ticket_docs','ticket_type'])->where('id',$id)->first();
        return view('employee/helpdesk/view_detail_ticket_dealer',compact('ticket'));
    }
    public function view_detail_ticket_customer($id)
    {   
        $ticket=customer_ticket::with(['ticket_docs','ticket_type'])->where('id',$id)->first();
        return view('employee/helpdesk/view_detail_ticket_customer',compact('ticket'));
    }
    public function non_approved_ticket()
    {
        // $user_id=Auth::guard('dealer')->user()->id;
        $customer_tickets=customer_ticket::with(['ticket_type','customer'])->where('ticket_category_id','1')->orderBy('id','desc')->get();
        $dealer_tickets=dealer_ticket::with(['ticket_type','dealer'])->where('ticket_category_id','1')->orderBy('id','desc')->get();
        // dd($dealer_tickets);
        return view('employee/helpdesk/non_approved_ticket',compact(['customer_tickets','dealer_tickets']));
    }
    public function dashboard()
    {
        ...
        $rej_contracts=contract::where('contract.status','0')->get()->count();
         // customer tickets
        $non_customer_tickets=customer_ticket::where('ticket_category_id','1')->where('ticket_status_id','1')->get()->count();
        $ip_customer_tickets=customer_ticket::where('ticket_category_id','1')->where('ticket_status_id','2')->get()->count();
        $comp_customer_tickets=customer_ticket::where('ticket_category_id','1')->where('ticket_status_id','3')->get()->count();
        // dealer tickets
        $non_dealer_tickets=dealer_ticket::where('ticket_status_id','1')->where('ticket_category_id','1')->get()->count();
        $ip_dealer_tickets=dealer_ticket::where('ticket_status_id','2')->where('ticket_category_id','1')->get()->count();
        $comp_dealer_tickets=dealer_ticket::where('ticket_status_id','3')->where('ticket_category_id','1')->get()->count();
        ...
        return view('employee/helpdesk/dashboard',compact(['non_contracts','ap_contracts','rej_contracts','non_ticket','ip_ticket','comp_ticket','customers','dealers']));
    }
    public function view_customers()
    {
        $customers=customer::where('status','1')->orderBy('id','desc')->get();
        return view('employee/helpdesk/view_customers',compact('customers'));
    }
    public function view_dealers()
    {
        $dealers=dealer::where('status','1')->orderBy('id','desc')->get();
        return view('employee/helpdesk/view_dealers',compact('dealers'));
    }
    public function dealer_info($id)
    {
        ...
        return view('employee/helpdesk/dealer_info',compact(['user','contracts']));
    }
    public function customer_details($id)
    {
        $customer=customer::with(['income','relative','bank','contracts.contract_type'])->where('id',$id)->first();
        return view('employee/helpdesk/customer_details',compact('customer'));
        
    }
    public function change_password()
    {
        return view('employee/helpdesk/change_password');
    }
    public function non_approved_contract()
    {
        ...
        return view('employee/helpdesk/non_approved_contract',compact('contracts'));
    }
    public function approved_contract()
    {
        ...
        return view('employee/helpdesk/approved_contract',compact('contracts'));
    }
    public function rejected_contract()
    {
        ...
        return view('employee/helpdesk/rejected_contract',compact('contracts'));
    }
    public function contract_detail($id)
    {
        ...
        // dd($get_contract);
        return view('employee/helpdesk/contract_detail',compact('get_contract'));
    }
    public function invoice_detail_page($id)
    {
        ...
        return view('employee/helpdesk/invoice_detail_page',compact('contract'));
    }
    public function add_notes()
    {
        return view('employee/helpdesk/add_notes');
    }
    ...
    public function view_notes()
    {
        ...
        return view('employee/helpdesk/view_notes',compact('notes'));
    }
    public function edit_notes($id)
    {
        $notes=employee_notes::where("id",$id)->first();
        return view('employee/helpdesk/edit_notes',compact('notes'));
    }
    ...
    {
        return view('employee/helpdesk/add_task');
    }
    ...
    public function view_todo_list()
    {
        ...
        // dd($tasks);
        return view('employee/helpdesk/view_todo_list',compact('tasks'));
    }
