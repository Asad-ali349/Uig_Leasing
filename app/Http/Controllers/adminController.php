...
class adminController extends Controller
{
    ...
    public function employee_info()
    {
        ...
        return view('employee/admin/employee_info',compact('employee'));
    }
    public function edit_employee_info()
    {
        ...
        $employee=employees::where('id',$user_id)->first();
        // dd($employee);
        return view('employee/admin/edit_employee_info',compact('employee'));
    }
    ...
    {   
        ...
        return view('employee/admin/view_detail_ticket_dealer',compact('ticket'));
    }
    public function view_detail_ticket_customer($id)
    {   
        $ticket=customer_ticket::with(['ticket_docs','ticket_type'])->where('id',$id)->first();
        return view('employee/admin/view_detail_ticket_customer',compact('ticket'));
    }
    public function non_approved_ticket()
    {
        // $user_id=Auth::guard('dealer')->user()->id;
        $customer_tickets=customer_ticket::with(['ticket_type','customer'])->where('ticket_category_id','8')->orderBy('id','desc')->get();
        $dealer_tickets=dealer_ticket::with(['ticket_type','dealer'])->where('ticket_category_id','8')->orderBy('id','desc')->get();
        // dd($dealer_tickets);
        return view('employee/admin/non_approved_ticket',compact(['customer_tickets','dealer_tickets']));
    }
    ...
    {   
        ...
        $rej_contracts=contract::where('contract.status','0')->get()->count();
         // customer tickets
        $non_customer_tickets=customer_ticket::where('ticket_category_id','8')->where('ticket_status_id','1')->get()->count();
        $ip_customer_tickets=customer_ticket::where('ticket_category_id','8')->where('ticket_status_id','2')->get()->count();
        $comp_customer_tickets=customer_ticket::where('ticket_category_id','8')->where('ticket_status_id','3')->get()->count();
        // dealer tickets
        $non_dealer_tickets=dealer_ticket::where('ticket_status_id','1')->where('ticket_category_id','8')->get()->count();
        $ip_dealer_tickets=dealer_ticket::where('ticket_status_id','2')->where('ticket_category_id','8')->get()->count();
        $comp_dealer_tickets=dealer_ticket::where('ticket_status_id','3')->where('ticket_category_id','8')->get()->count();
        ...
        $employees=employees::where('status','1')->where('role_id','!=','1')->get()->count();
        
        return view('employee/admin/dashboard',compact(['non_contracts','ap_contracts','rej_contracts','non_ticket','ip_ticket','comp_ticket','customers','dealers','employees']));
    }
    public function view_customers()
    {
        $customers=customer::orderBy('id','desc')->get();
        return view('employee/admin/view_customers',compact('customers'));
    }
    public function view_dealers()
    {
        $dealers=dealer::orderBy('id','desc')->get();
        return view('employee/admin/view_dealers',compact('dealers'));
    }
    public function dealer_info($id)
    {
        ...
        return view('employee/admin/dealer_info',compact(['user','contracts']));
    }
    public function customer_details($id)
    {
        $customer=customer::with(['income','relative','bank','contracts.contract_type'])->where('id',$id)->first();
        return view('employee/admin/customer_details',compact('customer'));
        
    }
    public function change_password()
    {
        return view('employee/admin/change_password');
    }
    public function non_approved_contract()
    {
        ...
        return view('employee/admin/non_approved_contract',compact('contracts'));
    }
    public function approved_contract()
    {
        ...
        return view('employee/admin/approved_contract',compact('contracts'));
    }
    public function rejected_contract()
    {
        ...
        return view('employee/admin/rejected_contract',compact('contracts'));
    }
    public function contract_detail($id)
    {
        ...
        // dd($get_contract);
        return view('employee/admin/contract_detail',compact('get_contract'));
    }
    public function add_notes()
    {
        return view('employee/admin/add_notes');
    }
    ...
    public function view_notes()
    {
        ...
        return view('employee/admin/view_notes',compact('notes'));
    }
    public function edit_notes($id)
    {
        $notes=employee_notes::where("id",$id)->first();
        return view('employee/admin/edit_notes',compact('notes'));
    }
    ...
    {
        return view('employee/admin/add_task');
    }
    ...
    public function view_todo_list()
    {
        ...
        // dd($tasks);
        return view('employee/admin/view_todo_list',compact('tasks'));
    }
    ...
    public function invoice_detail_page($id)
    {
        ...
        return view('employee/admin/invoice_detail_page',compact('contract'));
    }

    public function add_employee()
    {
        $roles=employee_roles::where('id','!=','1')->get();
        // dd($roles);
        return view('employee/admin/add_employee',compact('roles'));
    }
    ...
    public function view_employee()
    {
        ...
        // dd($employees);
        return view('employee/admin/view_employee',compact('employees'));
    }
    public function view_employee_detail($id)
    {
        $employee=employees::where('id',$id)->first();
        return view('employee/admin/view_employee_detail',compact('employee'));
    }
    ...
    {
        $interest_rate=contract_type::where('id','2')->first();
        return view("employee/admin/loan_interest",compact('interest_rate'));    
    }
    public function lease_interest()
    {
        $interest_rate=contract_type::where('id','1')->first();
        return view("employee/admin/lease_interest",compact('interest_rate'));    
    }
    public function submit_loan_interest(Request $req)
    {
        $validator = Validator::make($req->all(),[
        ...
        if($validator->fails())
        {
            ...
            $update=contract_type::where('id','2')->update([
                'interest_rate'=>$req->interest_rate,
            ]);
            if($update){
                return redirect()->back()->with('success_msg', "Successfully update");
            }else{
                return redirect()->back()->with('error_msg',"Unable to update loan interest");
            }

        }
    }
    public function submit_lease_interest(Request $req)
    {
        $validator = Validator::make($req->all(),[
            'interest_rate'=>'required',
        ]);
        if($validator->fails())
        {
            ...
            $update=contract_type::where('id','1')->update([
                'interest_rate'=>$req->interest_rate,
            ]);
            if($update){
                return redirect()->back()->with('success_msg', "Successfully update");
            }else{
                return redirect()->back()->with('error_msg',"Unable to update lease interest");
            }
        }
    }
    ...
    public function due_invoice($contract_id)
    {
        ...
        return view('employee/admin/due_invoice',compact(['in','pend_in']));
    }
    public function paid_invoice($contract_id)
    {
        ...
        return view('employee/admin/paid_invoice',compact('in'));
    }
    public function due_invoice_contract()
    {
        ...
        // dd($contracts);
        return view('employee/admin/due_invoice_contracts',compact('contracts'));
    }
    public function paid_invoice_contract()
    {
        ...
        return view('employee/admin/paid_invoice_contracts',compact('contracts'));
    }
    ...
    public function due_invoice_detail($id)
    {
        ...
        // dd($invoice);
        return view('employee/admin/due_invoice_detail',compact('invoice'));
    }
    public function paid_invoice_detail($id)
    {
        $invoice=invoices::with('customer')->where('id',$id)->first();
        // dd($invoice);
        return view('employee/admin/paid_invoice_detail',compact('invoice'));
    }
    public function dealer_due_invoice()
    {
        ...
        return view('employee/admin/dealer_due_invoice',compact('invoices'));
    }
    public function dealer_paid_invoice()
    {
        ...
        return view('employee/admin/dealer_paid_invoice',compact('invoices'));
    }
    public function dealer_invoice_detail($id)
    {
        $invoice=dealer_invoices::with(['dealer','contract.contract_type'])->where('id',$id)->orderBy('id','desc')->first();
        // dd($invoice);
        return view('employee/admin/dealer_invoice_detail',compact('invoice'));
    }
    public function dealer_transaction()
    {
        ...
        return view('employee/admin/dealer_transaction',compact('transactions'));
    }
    public function customer_transaction()
    {
        $transactions=customer_transaction::with(['invoice','contract.contract_type'])->orderBy('id','desc')->get();
        return view('employee/admin/customer_transaction',compact('transactions'));
    }
    ...
    public function view_reports()
    {
        ...
        return view('employee/admin/view_reports',compact(['filter','dealers','customers','customer_paid_sum','customer_paid_counts','customer_unpaid_sum','customer_unpaid_counts','dealer_paid_sum','dealer_paid_counts','dealer_unpaid_sum','dealer_unpaid_counts','contracts','contract_count'
        ]));
    }
    ...
    {
        $invoices=dealer_invoices::with('dealer')->where('contract_id',$contract_id)->orderBy('id','desc')->get();
        // dd($invoices);
        return view('employee/admin/contract_invoice_status_dealer',compact('invoices'));
    }
    public function contract_invoice_customer($contract_id)
    {
        ...
        // dd($invoices);
        return view('employee/admin/contract_invoice_status_customer',compact(['in','paid','pend_in']));
    }
