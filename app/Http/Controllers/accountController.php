...
class accountController extends Controller
{
    ...
    public function employee_info()
    {
        ...
        return view('employee/account/employee_info',compact('employee'));
    }
    public function edit_employee_info()
    {
        ...
        $user_id=Auth::guard('employee')->user()->id;
        $employee=employees::where('id',$user_id)->first();
        return view('employee/account/edit_employee_info',compact('employee'));
    }
    ...
    {   
        ...
        return view('employee/account/view_detail_ticket_dealer',compact('ticket'));
    }
    public function view_detail_ticket_customer($id)
    {   
        $ticket=customer_ticket::with(['ticket_docs','ticket_type'])->where('id',$id)->first();
        return view('employee/account/view_detail_ticket_customer',compact('ticket'));
    }
    public function non_approved_ticket()
    {
        // $user_id=Auth::guard('dealer')->user()->id;
        $customer_tickets=customer_ticket::with(['ticket_type','customer'])->where('ticket_category_id','2')->orderBy('id','desc')->get();
        $dealer_tickets=dealer_ticket::with(['ticket_type','dealer'])->where('ticket_category_id','2')->orderBy('id','desc')->get();
        // dd($dealer_tickets);
        return view('employee/account/non_approved_ticket',compact(['customer_tickets','dealer_tickets']));
    }
    ...
    public function dashboard()
    {
        ...
        return view('employee/account/dashboard',compact(['non_contracts','ap_contracts','rej_contracts','non_ticket','ip_ticket','comp_ticket','customers','dealers']));
    }
    public function view_customers()
    {
        $customers=customer::orderBy('id','desc')->get();
        return view('employee/account/view_customers',compact('customers'));
    }
    public function view_dealers()
    {
        $dealers=dealer::orderBy('id','desc')->get();
        return view('employee/account/view_dealers',compact('dealers'));
    }
    public function dealer_info($id)
    {
        ...
        return view('employee/account/dealer_info',compact(['user','contracts']));
    }
    public function customer_details($id)
    {
        $customer=customer::with(['income','relative','bank','contracts.contract_type'])->where('id',$id)->first();
        return view('employee/account/customer_details',compact('customer'));
        
    }
    public function change_password()
    {
        return view('employee/account/change_password');
    }
    public function non_approved_contract()
    {
        ...
        return view('employee/account/non_approved_contract',compact('contracts'));
    }
    public function approved_contract()
    {
        ...
        return view('employee/account/approved_contract',compact('contracts'));
    }
    public function rejected_contract()
    {
        ...
        return view('employee/account/rejected_contract',compact('contracts'));
    }
    public function contract_detail($id)
    {
        ...
        // dd($get_contract);
        return view('employee/account/contract_detail',compact('get_contract'));
    }
    ...
    public function invoice_detail_page($id)
    {
        ...
        return view('employee/account/invoice_detail_page',compact('contract'));
    }

    
    public function add_notes()
    {
        return view('employee/account/add_notes');
    }
    ...
    public function view_notes()
    {
        ...
        return view('employee/account/view_notes',compact('notes'));
    }
    public function edit_notes($id)
    {
        $notes=employee_notes::where("id",$id)->first();
        return view('employee/account/edit_notes',compact('notes'));
    }
    ...
    {
        return view('employee/account/add_task');
    }
    ...
    public function view_todo_list()
    {
        ...
        // dd($tasks);
        return view('employee/account/view_todo_list',compact('tasks'));
    }
    ...
    public function due_invoice($contract_id)
    {
        ...
        return view('employee/account/due_invoice',compact(['in','pend_in']));
    }
    public function paid_invoice($contract_id)
    {
        ...
        return view('employee/account/paid_invoice',compact('in'));
    }
    public function due_invoice_contract()
    {
        ...
        // dd($contracts);
        return view('employee/account/due_invoice_contracts',compact('contracts'));
    }
    public function paid_invoice_contract()
    {
        ...
        return view('employee/account/paid_invoice_contracts',compact('contracts'));
    }
    public function due_invoice_detail($id)
    {
        $invoice=invoices::with('customer')->where('id',$id)->first();
        // dd($invoice);
        return view('employee/account/due_invoice_detail',compact('invoice'));
    }
    public function paid_invoice_detail($id)
    {
        $invoice=invoices::with('customer')->where('id',$id)->first();
        // dd($invoice);
        return view('employee/account/paid_invoice_detail',compact('invoice'));
    }
    public function dealer_due_invoice()
    {
        ...
        return view('employee/account/dealer_due_invoice',compact('invoices'));
    }
    public function dealer_paid_invoice()
    {
        ...
        return view('employee/account/dealer_paid_invoice',compact('invoices'));
    }
    public function dealer_invoice_detail($id)
    {
        $invoice=dealer_invoices::with(['dealer','contract.contract_type'])->where('id',$id)->first();
        // dd($invoice);
        return view('employee/account/dealer_invoice_detail',compact('invoice'));
    }
    public function dealer_transaction()
    {
        ...
        return view('employee/account/dealer_transaction',compact('transactions'));
    }
    public function customer_transaction()
    {
        $transactions=customer_transaction::with(['invoice','contract.contract_type'])->orderBy('id','desc')->get();
        return view('employee/account/customer_transaction',compact('transactions'));
    }
    public function view_reports()
    {
        $dealers=dealer::where('status','1')->get();
        $customers=customer::where('status','1')->get();
        return view('employee/account/view_reports',compact(['dealers','customers']));
    }
    public function dealer_pay_invoice($invoice_id)
    {
        // dd($invoice_id);
        ...
        // $transactions=customer_transaction::with(['invoice','contract.contract_type'])->get();
        // return view('employee/account/customer_transaction',compact('transactions'));
    }
}
