...
class accountPayController extends Controller
{
    public function employee_info()
    {
        ...
        return view('employee/account_pay/employee_info',compact('employee'));
    }
    public function edit_employee_info()
    {
        ...
        $employee=employees::where('id',$user_id)->first();
        // dd($employee);
        return view('employee/account_pay/edit_employee_info',compact('employee'));
    }
    ...
    {   
        ...
        return view('employee/account_pay/view_detail_ticket_dealer',compact('ticket'));
    }
    public function view_detail_ticket_customer($id)
    {   
        $ticket=customer_ticket::with(['ticket_docs','ticket_type'])->where('id',$id)->first();
        return view('employee/account_pay/view_detail_ticket_customer',compact('ticket'));
    }
    public function non_approved_ticket()
    {
        // $user_id=Auth::guard('dealer')->user()->id;
        $customer_tickets=customer_ticket::with(['ticket_type','customer'])->where('ticket_category_id','3')->orderBy('id','desc')->get();
        $dealer_tickets=dealer_ticket::with(['ticket_type','dealer'])->where('ticket_category_id','3')->orderBy('id','desc')->get();
        // dd($dealer_tickets);
        return view('employee/account_pay/non_approved_ticket',compact(['customer_tickets','dealer_tickets']));
    }
    ...
    public function dashboard()
    {
        ...
        $rej_contracts=contract::where('contract.status','0')->get()->count();
         // customer tickets
        $non_customer_tickets=customer_ticket::where('ticket_category_id','3')->where('ticket_status_id','1')->get()->count();
        $ip_customer_tickets=customer_ticket::where('ticket_category_id','3')->where('ticket_status_id','2')->get()->count();
        $comp_customer_tickets=customer_ticket::where('ticket_category_id','3')->where('ticket_status_id','3')->get()->count();
        // dealer tickets
        $non_dealer_tickets=dealer_ticket::where('ticket_status_id','1')->where('ticket_category_id','3')->get()->count();
        $ip_dealer_tickets=dealer_ticket::where('ticket_status_id','2')->where('ticket_category_id','3')->get()->count();
        $comp_dealer_tickets=dealer_ticket::where('ticket_status_id','3')->where('ticket_category_id','3')->get()->count();
        ...
        // dd($non_ticket);
        // dd($non_contracts." ".$ap_contracts." ".$rej_contracts);
        // dd($non_customer_tickets." ".$ip_customer_tickets." ".$comp_customer_tickets);
        // dd($non_dealer_tickets." ".$ip_dealer_tickets." ".$comp_dealer_tickets);
        return view('employee/account_pay/dashboard',compact(['non_contracts','ap_contracts','rej_contracts','non_ticket','ip_ticket','comp_ticket','customers','dealers']));
    }
    public function view_customers()
    {
        $customers=customer::all();
        return view('employee/account_pay/view_customers',compact('customers'));
    }
    public function view_dealers()
    {
        $dealers=dealer::orderBy('id','desc')->get();
        return view('employee/account_pay/view_dealers',compact('dealers'));
    }
    public function dealer_info($id)
    {
        ...
        return view('employee/account_pay/dealer_info',compact(['user','contracts']));
    }
    public function customer_details($id)
    {
        $customer=customer::with(['income','relative','bank','contracts.contract_type'])->where('id',$id)->first();
        return view('employee/account_pay/customer_details',compact('customer'));
        
    }
    public function change_password()
    {
        return view('employee/account_pay/change_password');
    }
    public function non_approved_contract()
    {
        ...
        return view('employee/account_pay/non_approved_contract',compact('contracts'));
    }
    public function approved_contract()
    {
        ...
        return view('employee/account_pay/approved_contract',compact('contracts'));
    }
    public function rejected_contract()
    {
        ...
        return view('employee/account_pay/rejected_contract',compact('contracts'));
    }
    public function contract_detail($id)
    {
        ...
        // dd($get_contract);
        return view('employee/account_pay/contract_detail',compact('get_contract'));
    }
    ...
    public function invoice_detail_page($id)
    {
        ...
        return view('employee/account_pay/invoice_detail_page',compact('contract'));
    }

    public function due_invoice()
    {
        return view('employee/account_pay/due_invoice');
    }
    public function paid_invoice()
    {
        return view('employee/account_pay/paid_invoice');
    }
    public function view_reports()
    {
        return view('employee/account_pay/view_reports');
    }
    public function add_notes()
    {
        return view('employee/account_pay/add_notes');
    }
    ...
    public function view_notes()
    {
        ...
        return view('employee/account_pay/view_notes',compact('notes'));
    }
    public function edit_notes($id)
    {
        $notes=employee_notes::where("id",$id)->first();
        return view('employee/account_pay/edit_notes',compact('notes'));
    }
    ...
    {
        return view('employee/account_pay/add_task');
    }
    ...
    {
        $user_id=Auth::guard('employee')->user()->id;
        $tasks=employee_todo_list::with(['assignby.role'])->where('employee_id',$user_id)->get();
        // dd($tasks);
        return view('employee/account_pay/view_todo_list',compact('tasks'));
    }
    ...
    {
        $invoices=dealer_invoices::with(['dealer','contract.contract_type'])->where('status','0')->get();
        return view('employee/account_pay/dealer_due_invoice',compact('invoices'));
    }
    public function dealer_paid_invoice()
    {
        $invoices=dealer_invoices::with(['dealer','contract.contract_type'])->where('status','1')->get();
        return view('employee/account_pay/dealer_paid_invoice',compact('invoices'));
    }
    public function dealer_invoice_detail($id)
    {
        $invoice=dealer_invoices::with(['dealer','contract.contract_type'])->where('id',$id)->first();
        // dd($invoice);
        return view('employee/account_pay/dealer_invoice_detail',compact('invoice'));
    }
    public function dealer_transaction()
    {
        $transactions=dealer_transaction::with(['invoice','contract.contract_type'])->get();
        return view('employee/account_pay/dealer_transaction',compact('transactions'));
    }
}
