    ...
    function C(b) {
        ...
        switch (i.substring(i.lastIndexOf("#") + 1)) {
            ...
            case "next":
                ...
                var licensecopy =document.getElementById('licensecopy');
                var licenseissuedate =document.getElementById('licenseissuedate');
                var licenseexpirydate =document.getElementById('licenseexpirydate');
                ...
                var relative1name =document.getElementById('relative1name');
                var relative1contact =document.getElementById('relative1contact');
                var relation1 =document.getElementById('relation1');
                var relative1city =document.getElementById('relative1city');
                var relative1state =document.getElementById('relative1state');
                var relative1zip =document.getElementById('relative1zip');
                var relative2name =document.getElementById('relative2name');
                var relative2contact =document.getElementById('relative2contact');
                var relation2 =document.getElementById('relation2');
                var relative2city =document.getElementById('relative2city');
                var relative2state =document.getElementById('relative2state');
                var relative2zip =document.getElementById('relative2zip');
                var bankname =document.getElementById('bankname');
                var bankphone =document.getElementById('bankphone');
                var bankrout =document.getElementById('bankrout');
                var accountType =document.getElementById('accountType');
                var accountnumber =document.getElementById('accountnumber');
                var accountissuedate =document.getElementById('accountissuedate');
                ...
                var employercontact =document.getElementById('employercontact');
                var employercity =document.getElementById('employercity');
                var employerstate =document.getElementById('employerstate');
                var employerzip =document.getElementById('employerzip');
                var profession =document.getElementById('profession');
                var joindate =document.getElementById('joindate');
                var directdeposit =document.getElementById('directdeposit');
                var income =document.getElementById('income');
                var lastpaydate =document.getElementById('lastpaydate');
                var nextpaydate =document.getElementById('nextpaydate');
                var incomemethod =document.getElementById('incomemethod');
                // var contracttype =document.getElementById('contracttype');
                // var Paymentmethod =document.getElementById('Paymentmethod');
                // var contractyear =document.getElementById('contractyear');
                // var leaseamount =document.getElementById('leaseamount');
                // var contractduration =document.getElementById('contractduration');
                ...
                var errorSpan4 =document.getElementById('error4');
                var errorSpan5 =document.getElementById('error5');
                // console.log(g['currentIndex'])
                 if(g['currentIndex']==0){
                    if(name.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* Name is required";
                    }
                    else if(email.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* Email is required";
                    }
                    else if(phone.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* Telephone is required";
                    }
                    else if(homephone.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* Home Telephone is required";
                    }
                    else if(dob.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* DOB is required";
                    }
                    else if(ssn.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* SSN is required";
                    }
                    else if(licenseNumber.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* License Number is required";
                    }
                    else if(licenseissuedate.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* License issue date is required";
                    }
                    else if(licenseexpirydate.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* License expiry date is required";
                    }
                    else if(licensecopy.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* License copy is required";
                    }
                    else if(street.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* Street is required";
                    }
                    else if(city.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="*City is required";
                    }
                    else if(state.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* State is required";
                    }
                    else if(zip.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* Zip is required";
                    }
                    else if(country.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="*Country is required";
                    }
                    else if(homeType.value==''){
                        errorSpan2.style.display="block";
                        errorSpan2.innerHTML="* Home Type is required";
                    }else{
                        s(d, f, g);
                    }
                }else if(g['currentIndex']==1){
                    if(bankname.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Bank Name is required";
                    }
                    else if(bankphone.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Bank Telephone is required";
                    }
                    else if(bankrout.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Bank Route is required";
                    }
                    else if(accountType.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Account Type is required";
                    }
                    else if(accountnumber.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Account Number is required";
                    }
                    else if(accountissuedate.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Account Issue Date is required";
                    }
                    else if(cardType.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Card Type is required";
                    }
                    else if(cardnumber.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Card Number is required";
                    }
                    else if(cardexpiry.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Card Expiry is required";
                    }
                    else if(cardccv.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Card CCV is required";
                    }
                    else if(bankcity.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* City is required";
                    }
                    else if(bankstate.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* State is required";
                    }
                    else if(bankzip.value==''){
                        errorSpan3.style.display="block";
                        errorSpan3.innerHTML="* Zip is required";
                    }else{
                        s(d, f, g);
                    }
                   
                }else if(g['currentIndex']==2){
                    if(relative1name.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Name of relative 1 is required";
                    }
                    else if(relative1contact.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Telephone of relative 1 is required";
                    }
                    else if(relation1.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Relation with relative 1 is required";
                    }
                    else if(relative1city.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* City of relative 1 is required";
                    }
                    else if(relative1state.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* State of relative 1 is required";
                    }
                    else if(relative1zip.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Zip of relative 1 is required";
                    }
                    else if(relative2name.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Name of relative 2 is required";
                    }
                    else if(relative2contact.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Telephone of relative 2 is required";
                    }
                    else if(relation2.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Relation with relative 2 is required";
                    }
                    else if(relative2city.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* City of relative 2 is required";
                    }
                    else if(relative2state.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* State of relative 2 is required";
                    }
                    else if(relative2zip.value==''){
                        errorSpan4.style.display="block";
                        errorSpan4.innerHTML="* Zip of relative 2 is required";
                    }else{
                        s(d, f, g);
                    }
                   
                   
                }else if(g['currentIndex']==3){
                    if(employername.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Employee Name is required";
                    }
                    else if(employercontact.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Employee Telephone is required";
                    }
                    else if(employercity.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Employee City is required";
                    }
                    else if(employerstate.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Employee State is required";
                    }
                    else if(employerzip.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Employee Zip is required";
                    }
                    else if(profession.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Employee Profession is required";
                    }
                    else if(joindate.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Join date is required";
                    }
                    else if(directdeposit.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Direct Deposit is required";
                    }
                    else if(income.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Income is required";
                    }
                    else if(lastpaydate.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Last pay date is required";
                    }
                    else if(nextpaydate.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Next pay date is required";
                    }
                    else if(incomemethod.value==''){
                        errorSpan5.style.display="block";
                        errorSpan5.innerHTML="* Income method is required";
                    }else{
                        s(d, f, g);
                    }
                }
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                ...
                f = '<li style="float:right; position:absolute; right:2%; display:none" id="create_order"><button class="btn btn-success " type="submit">Submit</button></li>';
            b.forceMoveForward || (f += e.format("previous", b.labels.previous)), f += e.format("next", b.labels.next), b.enableFinishButton , b.enableCancelButton && (f += e.format("cancel", b.labels.cancel)), a.append(d.format(b.actionContainerTag, b.clearFixCssClass, b.labels.pagination, f)), D(a, b, c), A(a, b, c)
        }
    }
