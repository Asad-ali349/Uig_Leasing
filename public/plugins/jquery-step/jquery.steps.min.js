    ...
    function C(b) {
        ...
        switch (i.substring(i.lastIndexOf("#") + 1)) {
            ...
            case "next":
                ...
                // console.log(a(this))
                var contype=document.getElementById('contracttype');
                ...
                if(contype.value == ''){
                    ...
                    errorSpan.innerHTML="* Contract Type is required";
                }else if(profilestatus.value != '100'){
                    errorSpan.style.display="block";
                    errorSpan.innerHTML="* Complete your profile in order to apply for contract";
                }else if(customerprofilestatus.value != '100'){
                    errorSpan.style.display="block";
                    errorSpan.innerHTML="* Customer Profile is not completed";
                }else if(Paymentmethod.value == ''){
                    errorSpan.style.display="block";
                    errorSpan.innerHTML="* Payment Type is required";
                }else if(contractyear.value == ''){
                    errorSpan.style.display="block";
                    errorSpan.innerHTML="* Contract Year is required";
                }else if(customer.value == ''){
                    errorSpan.style.display="block";
                    errorSpan.innerHTML="* Customer is required";
                }else if(invoice.value == ''){
                    errorSpan.style.display="block";
                    errorSpan.innerHTML="* Invoice number is required";
                }else{
                    s(d, f, g);
                }
